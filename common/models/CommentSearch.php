...
class CommentSearch extends Comment
{
    ...
    {
//        return array_merge; // TODO: Change the autogenerated stub
        return array_merge(parent::attributes(),['user.username', 'postTitle']);
    }
    ...
    public function rules()
    {
        return [
            ...
            [['content', 'email', 'url', 'user.username', 'postTitle'], 'safe'],
        ];
    }
